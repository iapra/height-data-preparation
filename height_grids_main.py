...
idw = True
nn = False
### CLEAN-UP TO DELETE TEMP FILES CONTAINING PDAL PIPELINES
clean_up = True

# NECESSARY INPUT: A SINGLE MERGED POINT CLOUD
...
for img_name in os.listdir(DIR_IMAGES_GEOTIFF):
    if img_name[-4:] != ".tif":
        ...
        if not os.path.exists(las_cropped):
